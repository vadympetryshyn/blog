...
class Newsmag_Lite {
	...
	public function enqueues() {
		 ...
		 * Load Google Fonts
		 */
		wp_enqueue_style( 'newsmag-fonts', '//fonts.googleapis.com/css?family=Lato:100,300,400,700,900|Roboto:400,500,600,700&subset=cyrillic', array(), $newsmag['Version'], 'all' );
		...
		$preloader_accent = get_theme_mod( 'newsmag_preloader_color', '#2f3759' );

		if ( $preloader && strtolower( $preloader_accent ) !== '#2f3759' ) {
		...
		wp_localize_script(
			'newsmag-functions', 'WPUrls', array(
	...
	public function theme_setup() {
		...
		add_theme_support(
			'custom-background', apply_filters(
				'newsmag_custom_background_args', array(

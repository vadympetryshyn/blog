...
Description: Integrate Facebook Comments and Disqus Comments along with default WordPress Comments
Version: 1.4.16
Author: Team Heateor
...
define( 'HEATEOR_SOCIAL_COMMENTS_VERSION', '1.4.16' );
...
function heateor_sc_init() {
	...
	if( isset( $heateor_sc_options['enable_facebookcomments'] ) || isset( $heateor_sc_options['enable_disquscomments'] ) ) {
...
function heateor_sc_render_fb_comments() {
	...
	$commentingHtml .= '!function(e,n,t){var o,c=e.getElementsByTagName(n)[0];e.getElementById(t)||(o=e.createElement(n),o.id=t,o.src="//connect.facebook.net/' . ( isset($heateor_sc_options['comment_lang']) && $heateor_sc_options['comment_lang'] != '' ? $heateor_sc_options["comment_lang"] : 'en_US' ) . '/sdk.js#xfbml=1&version=v3.2' . ( $heateor_sc_options['fb_app_id'] != '' ? '&appId=' . $heateor_sc_options["fb_app_id"] : '' ) . '",c.parentNode.insertBefore(o,c))}(document,"script","facebook-jssdk");</script>';

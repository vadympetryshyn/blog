			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form-table editcomment menu_content_table">
				...
				<tr>
					...
					<ul style="margin: 0" id="heateor_sc_comments_order">
						<?php
						$savedOrder = isset( $heateor_sc_options['commenting_order'] ) ? $heateor_sc_options['commenting_order'] : 'wordpress,facebook,disqus';
		...
		<div class="stuffbox">
			...
			<div class="inside" style="padding-left:7px">
				<p><?php _e('<strong>Note: </strong>', 'heateor-social-comments');
					 _e('Default comment form must be enabled at the webpages where you want social comments to work.', 'heateor-social-comments'); ?>
				</p>
